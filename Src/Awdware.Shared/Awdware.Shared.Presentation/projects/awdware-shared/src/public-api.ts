/*
 * Public API Surface of awdware-shared
 */
...
export * from './lib/models/tab-view-tab';
export * from './lib/models/theme.model';
export * from './lib/models/validation-definition';
export * from './lib/models/validation-error-type';
